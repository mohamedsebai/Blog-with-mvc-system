...
<div class="main-body cat_main_body">
  <div class="container">
   ...
   <div class="row">
     ...
     <div class="alert alert-danger">Mohamed shares no post in this search</div>
  <?php endif; ?>
   </div>
   ...
   <div class="order-list">
     <ul class="list-unstyled">
       <?php for($page = 1; $page <= $number_of_page; $page++){ ?>
          <li> <a href="<?php echo BASEURL; ?>/search/pages/?page=<?php echo $page; ?>&search=<?php echo $search; ?>"><?php echo $page; ?></a></li>
        <?php } ?>
     </ul>
   </div>
